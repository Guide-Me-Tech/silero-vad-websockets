    ...
    try:
        with wave.open(audio_file, 'rb') as wav_file:
            ...
            while frames_sent < n_frames:
                ...
                logger.info(f"Sent chunk: {len(audio_data)} bytes, {frames_sent}/{n_frames} frames")
...
async def main():
    ...
    try:
        async with websockets.connect(uri) as websocket:
            ...
            send_task = asyncio.create_task(send_audio_chunks(websocket, str(audio_path), args.chunk_ms))
